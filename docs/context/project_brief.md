...
**管理機能（13UC）**
- [ ] ユーザー管理（5-1）
- [ ] LLM管理（5-2〜5-8）: モデル登録/切替/プロンプト/パラメータ/ワークフロー/使用量監視/フォールバック
- [ ] Embedding管理（5-9〜5-10）: モデル設定/使用量監視（Phase 2）
- [ ] 学習コンテンツ管理（5-11〜5-12）: 登録/管理（Phase 2）
- [ ] システム設定（5-13）
...
| 2025-12-08 | クラス図・機能一覧表 | クラス図v1.6、機能一覧表v1.5（82点B評価） |
| 2025-12-12 | 業務フロー図完成 | 11/11全フロー完了、UCカバレッジ100% |
| 2025-12-14 | シーケンス図統合版 | 認証/プロジェクトCRUD/図表作成（3/14完了） |
| 2025-12-16 | UC 3-3〜3-5 シーケンス図 | 編集プレビュー/保存（5/14完了）、知見24項目発見 |
| 2025-12-18 | 知見統合・ディレクトリ再構成 | LL-001〜024知見ベース、proposals番号プレフィックス追加 |
...
- [x] 業務フロー図（11/11完了、全フロー完了）
- [x] データフロー図（DFD v5.0 draw.io形式）
- [x] 機能一覧表（v3.12 93点A評価）
- [x] クラス図（v1.7 100点A評価）
- [x] CRUD表（v2.2）
- [x] シーケンス図（5/14完了、MVP 5/8）
- [x] データ保存設計決定（TD-006: Storage Only）
- [ ] シーケンス図残り（MVP3本 + Phase2 6本）
- [ ] 画面遷移図、ワイヤーフレーム
- [ ] コンポーネント図、外部インターフェース一覧
- [ ] 非機能要件一覧表、アクター権限マトリクス
- [ ] PRD本体
