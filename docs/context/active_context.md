...
| ⑩ ワイヤーフレーム | 🟡 | 100点 | 7/17（Phase A完了、#9新規図表作成✅）|
| ⑪ コンポーネント図 | 🔴 | - | 要作成 |
| ⑫ 外部インターフェース一覧 | 🔴 | - | 要作成 |
| ⑬ 非機能要件一覧表 | 🔴 | - | 要作成 |
| ⑭ アクター権限マトリクス | 🔴 | - | 要作成 |
...
| **1** | **⑩ ワイヤーフレーム** | Excalidraw | 🟡 進行中 | 3/17（#1 ログイン✅、#2 ホーム✅、#3 プロジェクト詳細✅）|
...
| 1 | 6 | **新規PJ作成** | UC 2-1 | 低 | **次に着手** |
| 2 | 7 | PJ編集 | UC 2-3 | 低 | #6構造再利用 |
| 3 | 8 | PJ削除確認 | UC 2-4 | 最低 | 確認ダイアログ |
...
| 順序 | # | 画面名 | 対応UC | 複雑度 | 備考 |
|:----:|:-:|--------|--------|:------:|------|
| 5 | 9 | 新規図表作成 | UC 3-1 | 低 | モーダル |
| 6 | 10 | テンプレート選択 | UC 3-2 | 中 | カテゴリ構造 |
| 7 | 4 | **エディタ画面** | UC 3-1〜3-6, 4-1, 4-2 | **最高** | **8UC統合・状態分離必須** |
