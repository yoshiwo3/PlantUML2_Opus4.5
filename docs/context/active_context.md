...
**最終更新**: 2025-12-14（プロジェクトCRUDシーケンス図追加）
...
| ⑧ シーケンス図 | 🟡 | 2/14完了（MVP: 2/8、Phase2: 0/6）※v3除外 |
| ⑨ 画面遷移図 | 🔴 | 要作成 |
| ⑩ ワイヤーフレーム | 🔴 | 要作成 |
| ⑪ コンポーネント図 | 🔴 | 要作成 |
| ⑫ 外部インターフェース一覧 | 🔴 | 要作成 |
...
| 3 | 図表作成・テンプレート | 3-1, 3-2 | Supabase Storage | 🔴 要作成 |
| 4 | 編集・プレビュー | 3-3, 3-4 | node-plantuml + OpenRouter | 🔴 要作成 |
...
- **プロジェクトCRUDシーケンス図（4図）追加** ✅
  - UC 2-1〜2-4（プロジェクト作成/選択/編集/削除）
  - 4パス視覚的レビュー完了
  - SVG: `docs/proposals/diagrams/sequence/`に保存
  - 正式版: `PlantUML_Studio_シーケンス図_プロジェクトCRUD_20251214.md`
  - **シーケンス図進捗: 1/14 → 2/14（MVP: 2/8）**

- **シーケンス図進捗修正** 🔄
  - proposalsに存在するシーケンス図を確認: **1本のみ**（認証フロー）
  - プロジェクトCRUDシーケンス図は削除済みのため、進捗を修正
...
10. [ ] **Phase 4: シーケンス図**（残り13件: MVP7本+Phase2 6本）← **次の作業**
...
- [ ] Phase 4: 振る舞い詳細化（シーケンス図残り13件: MVP7本+Phase2 6本、画面遷移図、ワイヤーフレーム）← **次**
