...
**最終更新**: 2025-12-21（UC 5-1統合版追記完了、ドキュメント統合評価95点満点）
...
| ⑧ シーケンス図 | 🟡 | 100点S | 11/14完了（MVP: 8/8 ✅、Phase 2: 3/6）|
| ⑨ 画面遷移図 | 🔴 | - | 要作成 |
| ⑩ ワイヤーフレーム | 🔴 | - | 要作成 |
| ⑪ コンポーネント図 | 🔴 | - | 要作成 |
| ⑫ 外部インターフェース一覧 | 🔴 | - | 要作成 |
...
| **1** | **UC 5-2** | **LLMモデル登録** | OpenRouter + Supabase | 🔴 次 |
| 2 | UC 5-7 | LLM使用量監視 | OpenRouter + Supabase | 🔴 |
| 3 | UC 5-11 | 学習コンテンツ登録 | OpenAI Embedding + pgvector | 🔴 |
