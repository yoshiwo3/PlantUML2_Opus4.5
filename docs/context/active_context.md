...
| ⑨ 画面遷移図 | 🟡 | - | 19ノード定義済み、SVG未生成 |
| ⑩ ワイヤーフレーム | 🔴 | - | 0/19（認証→メイン→モーダル→管理の順で作成）|
| ⑪ コンポーネント図 | 🔴 | - | 要作成 |
| ⑫ 外部インターフェース一覧 | 🔴 | - | 要作成 |
| ⑬ 非機能要件一覧表 | 🔴 | - | 要作成 |
| ⑭ アクター権限マトリクス | 🔴 | - | 要作成 |
...
| 2 | 新規登録画面 | signup | UC 1-1 | 🔴 | ✅ | MVP |
| 3 | パスワードリセット | reset | UC 1-1 | 🔴 | ✅ | MVP |

#### メイン画面群（3画面）

| # | 画面名 | alias | 対応UC | ワイヤーフレーム | 遷移図ノード | 優先度 |
|:-:|--------|-------|--------|:--------------:|:----------:|:------:|
| 4 | ダッシュボード | dashboard | UC 2-1 | 🔴 | ✅ | MVP |
| 5 | プロジェクト詳細 | project_detail | UC 2-2〜2-4 | 🔴 | ✅ | MVP |
| 6 | エディタ画面 | editor | UC 3-1〜3-6, 4-1, 4-2 | 🔴 | ✅ | MVP |

#### モーダル群（8画面）

| # | 画面名 | alias | 対応UC | ワイヤーフレーム | 遷移図ノード | 優先度 |
|:-:|--------|-------|--------|:--------------:|:----------:|:------:|
| 7 | 新規プロジェクト作成 | new_project | UC 2-1 | 🔴 | ✅ | MVP |
| 8 | プロジェクト編集 | edit_project | UC 2-3 | 🔴 | ✅ | MVP |
| 9 | プロジェクト削除確認 | delete_project | UC 2-4 | 🔴 | ✅ | MVP |
| 10 | 新規図表作成 | new_diagram | UC 3-1 | 🔴 | ✅ | MVP |
| 11 | テンプレート選択 | template | UC 3-2 | 🔴 | ✅ | MVP |
| 12 | エクスポート設定 | export | UC 3-6 | 🔴 | ✅ | MVP |
| 13 | 図表削除確認 | delete_diagram | UC 3-9 | 🔴 | ✅ | MVP |
| 14 | AIチャット | ai_chat | UC 4-2 | 🔴 | ✅ | MVP |

#### 管理画面群（5画面）

| # | 画面名 | alias | 対応UC | ワイヤーフレーム | 遷移図ノード | 優先度 |
|:-:|--------|-------|--------|:--------------:|:----------:|:------:|
| 15 | 管理ダッシュボード | admin_dashboard | - | 🔴 | ✅ | MVP |
| 16 | ユーザー管理 | user_mgmt | UC 5-1 | 🔴 | ✅ | MVP |
| 17 | LLMモデル管理 | llm_mgmt | UC 5-2〜5-5 | 🔴 | ✅ | MVP |
| 18 | 使用量監視 | usage_monitor | UC 5-7, 5-8 | 🔴 | ✅ | MVP |
| 19 | 学習コンテンツ管理 | learning_mgmt | UC 5-11, 5-12 | 🔴 | ✅ | Phase 2 |

**UI設計図表 進捗**:
- **遷移図ノード**: 19/19 完了（100%）✅
- **ワイヤーフレーム**: 0/19 未着手（0%）🔴
- **MVP画面**: 18画面 / **Phase 2画面**: 1画面

**遷移図ファイル**: `docs/proposals/diagrams/09_screen_transition/99_screen_transition.puml`
...
| 優先度 | 図表 | ツール | 状況 | 備考 |
|:------:|------|--------|:----:|------|
| ~~0~~ | ~~画面一覧確定~~ | - | ✅ | 19画面を詳細進捗テーブルに追加済み |
| **1** | **⑩ ワイヤーフレーム** | Excalidraw | 🔴 次 | 0/19（#1 ログイン画面から開始）|
| ~~2~~ | ~~⑨ 画面遷移図~~ | PlantUML | 🟡 | 19ノード定義済み、SVG未生成 |
