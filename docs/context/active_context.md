...
| **1** | **⑩ ワイヤーフレーム** | Excalidraw | 🟡 進行中 | 2/17（#1 ログイン✅、#2 ホーム✅（3ビュー構成））|
...
**残り15画面**を4フェーズで作成。依存関係と複雑度に基づく推奨順序。
...
| 順序 | # | 画面名 | 対応UC | 複雑度 | 備考 |
|:----:|:-:|--------|--------|:------:|------|
| 1 | 3 | **プロジェクト詳細** | UC 2-2〜2-4 | 中 | **次に着手** |
| 2 | 6 | 新規PJ作成 | UC 2-1 | 低 | モーダル |
| 3 | 7 | PJ編集 | UC 2-3 | 低 | #6構造再利用 |
| 4 | 8 | PJ削除確認 | UC 2-4 | 最低 | 確認ダイアログ |

**Phase A完了時**: 6/18画面（33%）
