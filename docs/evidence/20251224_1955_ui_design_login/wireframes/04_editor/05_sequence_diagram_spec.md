...
6. [[#6. S2: 要素一覧セクション|S2: 要素一覧セクション]]
    ...
    - [[#6.9 参加者ライフサイクル（create/destroy）|6.9 create/destroy]]
...
|--------|:-------------:|-----------|:-----------:|------|
| **Mode 1（デフォルト）** | Ctrl+1 | GUI + Code + Preview | 200-800px（リサイザー調整） | 標準編集 |
| **Mode 2** | Ctrl+2 | GUI + Preview | Code非表示分が加算 | GUI集中編集 |
| **Mode 3** | Ctrl+3 | Code + Preview | GUI非表示 | コード直接編集 |
