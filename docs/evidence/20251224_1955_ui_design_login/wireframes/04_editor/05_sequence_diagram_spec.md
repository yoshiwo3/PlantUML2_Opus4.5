...
│ Ref: TD-015 (低精度WF), TD-006 (Storage設計) | パネル幅 GUI 600 + (Code+Prev) 1320 = 1920px     │
├─────────────────────────────────────────────────────────────────────────────────────────────────┤
...
│ ┌──────────────────────────┐ │                          │                                        │
│ │ ≡ 1. User→AuthService:  │ │                          ├────────────────────────────────────────┤
│ │       login()    [✎][🗑]│ │                          │ AI Chat パネル [▲] │ Claude 3.5 ▼     │
│ │ ┌────────────────────┐   │ │                          │ [学習モード][▶ 適用][再生成][○]       │
│ │ │ 認証処理           │   │ │                          ├────────────────────────────────────────┤
│ │ │ ≡ 2. AuthService→ │   │ │                          │ AIとの対話履歴がここに表示されます... │
│ │ │   Database:query() │   │ │                          │                                        │
│ │ │ ≡ 3. Database→    │   │ │                          │ ┌────────────────────────────[送信]─┐ │
│ │ │   AuthService:result│   │ │                          │ │ 💬 メッセージを入力...             │ │
│ │ │ ≡ 4. AuthService→ │   │ │                          │ └────────────────────────────────────┘ │
│ │ │   User:token       │   │ │                          │                                        │
│ │ └────────────────────┘   │ │                          │                                        │
│ │ ≡ 5. User→Dashboard:   │ │                          │                                        │
...
- 縦: 48 + 832 + 200 = **1080px** ✓（Code/Preview + AIチャット）
...
> **折りたたみ時**: Code/Previewパネルが下方向に拡張（+164px〜+364px）。GUIパネルは常にフル高さを維持。
