...
| **区切り線** | インライン（§6.8.3） | インライン（§6.8.6） | ダイアログ（§12.8） | §6.8 |
| **スペース** | インライン（§6.8.3） | インライン（§6.8.6） | ダイアログ（§12.8） | §6.8 |
| **遅延** | インライン（§6.8.3） | インライン（§6.8.6） | ダイアログ（§12.8） | §6.8 |
| **create** | インライン（§6.9.2） | インライン（§6.9.4） | ダイアログ（§12.8） | §6.9 |
| **destroy** | インライン（§6.9.3） | インライン（§6.9.4） | ダイアログ（§12.8） | §6.9 |
