...
**重要更新**: **7機能をv1.1延期** - TD-017, 024, 025, 026, 028, 029, 031（MVPスコープ絞り込み）
...
| TD | タイトル | セッション | 優先度 |
|:--:|---------|:----------:|:------:|
| **TD-017** | GUIパネルの図表タイプ別動的切り替え | 12 | **⏸️ v1.1延期** |
...
### 1.2 MVP延期機能一覧（7機能）⚡ **Session 13 Phase 4追加**
...
|:--:|--------|:------:|:----:|----------|----------|
| **017** | GUIパネル動的切り替え | 63 | D | シーケンス図以外の図表タイプ対応が未設計 | MVP: シーケンス図固定、v1.1: 他タイプ対応 |
...
| **028** | AIコード適用 | 55 | F | 「適用」ボタンの適用ロジック（挿入/置換/マージ）未定義 | MVP: コピーボタンのみ、v1.1: 差分プレビュー+適用 |
