...
### 3.2 02_selection_mode.excalidraw（選択モードON）
...
| エリア | 要素 | 備考 |
|--------|------|------|
| **GUIパネル** | メッセージカード選択可能状態 | クリックで選択 |
| **GUIパネル** | 選択済みカードハイライト | 背景色変更 |
| **GUIパネル** | [選択クリア]ボタン | - |
| **Codeパネル** | 選択モードトグル（**ON状態**） | 枠線色変更 |
| **Codeパネル** | 選択範囲ハイライト（黄色背景） | - |
| **Codeパネル** | 枠線色変更（選択モード中） | 視覚的フィードバック |
| **Previewパネル** | 対応メッセージ色変更 | 連動ハイライト |
