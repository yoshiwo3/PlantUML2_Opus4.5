...
| 13 | **ユーザー確認（Step 6）をスキップする（CS-005違反）** | 協調作成プロセスの根本違反。AIは作成者であり判断者ではない |
...
>
> **CS-005参照**: ワイヤーフレーム作成後、必ずユーザーに提示して確認を得ること。「進んでください」は**現在の1タスクに対する承認**であり、後続タスクの自動承認ではない。詳細は `UI_Design_Knowledge_Base.md` §CS-005 参照。
...
| 日付 | Ver | 内容 |
|------|:---:|------|
| 2025-12-28 | **3.8** | **§2禁止事項#13追加**: 「ユーザー確認（Step 6）スキップ禁止」（CS-005違反）、協調作成プロセスの根本違反を明示化 |
