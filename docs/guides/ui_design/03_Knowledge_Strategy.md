...
| 分類 | 項目数 | 内容 |
|------|:------:|------|
| EX-001〜 | 4+ | Excalidraw関連（ワイヤーフレーム作成） |
| SD-001〜 | 5+ | State Diagram関連（画面遷移図作成） |
| TD-001〜 | 3+ | TD-015適用知見（低精度、手書き風、グレースケール） |
| IC-001〜 | 3+ | 整合性チェック知見（3点対比、孤立ノード等） |
...
| 制約 | 説明 |
|------|------|
| 憲法の安定性 | UI設計図表開発憲法 v3.0の既存内容は最小限の変更 |
...
```
UI_Design_Constitution.md (v3.0)
    │
    ├── §8 UI設計パターンチェックリスト
...
| ファイル | 役割 | ステータス |
|---------|------|:----------:|
| `UI_Design_Constitution.md` | 憲法本体 | ✅ v3.0 |
